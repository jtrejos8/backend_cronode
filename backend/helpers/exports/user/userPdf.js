...
function createStringToPDF(data) {
    ...
    * {
    ...
    if (lunes.length > 0) {
        ...
        <td>
            <p>${lunes[i].programation.group.formationProgram.name}</p>
            <p>Ficha: ${lunes[i].programation.group.codeTab}</p>
            <p>${lunes[i].ambient.name}</p>
            <p>
        ...
        <tr style='height: ${calcHalfHours(lunes[i].endDate, endDate) * 18}px'>
          <td class='ready'>
            <p>Libre</p>
            <p>
              ${new Date(lunes[i].endDate).getHours()}:${new Date(lunes[i].endDate).getMinutes()} - ${endDate.getHours()}:${endDate.getMinutes()==0?endDate.getMinutes()+"0":endDate.getMinutes()}
            </p>
          </td>
        </tr>
        `;
    ...
    if (martes.length > 0) {
        ...
        <td>
            <p>${martes[i].programation.group.formationProgram.name}</p>
            <p>Ficha: ${martes[i].programation.group.codeTab}</p>
            <p>${martes[i].ambient.name}</p>
            <p>
        ...
        <tr style='height: ${calcHalfHours(martes[i].endDate, endDate) * 18}px'>
          <td class='ready'>
            <p>Libre</p>
            <p>
              ${new Date(martes[i].endDate).getHours()}:${new Date(martes[i].endDate).getMinutes()} - ${endDate.getHours()}:${endDate.getMinutes()==0?endDate.getMinutes()+"0":endDate.getMinutes()}
            </p>
          </td>
        </tr>
        `;
    ...
    if (miercoles.length > 0) {
        ...
        <td>
            <p>${miercoles[i].programation.group.formationProgram.name}</p>
            <p>Ficha: ${miercoles[i].programation.group.codeTab}</p>
            <p>${miercoles[i].ambient.name}</p>
            <p>
        ...
        <tr style='height: ${calcHalfHours(miercoles[i].endDate, endDate) * 18}px'>
          <td class='ready'>
            <p>Libre</p>
            <p>
              ${new Date(miercoles[i].endDate).getHours()}:${new Date(miercoles[i].endDate).getMinutes()} - ${endDate.getHours()}:${endDate.getMinutes()==0?endDate.getMinutes()+"0":endDate.getMinutes()}
            </p>
          </td>
        </tr>
        `;
    ...
    if (jueves.length > 0) {
        ...
        <td>
            <p>${jueves[i].programation.group.formationProgram.name}</p>
            <p>Ficha: ${jueves[i].programation.group.codeTab}</p>
            <p>${jueves[i].ambient.name}</p>
            <p>
        ...
        <tr style='height: ${calcHalfHours(jueves[i].endDate, endDate) * 18}px'>
          <td class='ready'>
            <p>Libre</p>
            <p>
              ${new Date(jueves[i].endDate).getHours()}:${new Date(jueves[i].endDate).getMinutes()} - ${endDate.getHours()}:${endDate.getMinutes()==0?endDate.getMinutes()+"0":endDate.getMinutes()}
            </p>
          </td>
        </tr>
        `;
    ...
    if (viernes.length > 0) {
        ...
        <td>
            <p>${viernes[i].programation.group.formationProgram.name}</p>
            <p>Ficha: ${viernes[i].programation.group.codeTab}</p>
            <p>${viernes[i].ambient.name}</p>
            <p>
        ...
        <tr style='height: ${calcHalfHours(viernes[i].endDate, endDate) * 18}px'>
          <td class='ready'>
            <p>Libre</p>
            <p>
              ${new Date(viernes[i].endDate).getHours()}:${new Date(viernes[i].endDate).getMinutes()} - ${endDate.getHours()}:${endDate.getMinutes()==0?endDate.getMinutes()+"0":endDate.getMinutes()}
            </p>
          </td>
        </tr>
        `;
    ...
    if (sabado.length > 0) {
        ...
        <td>
            <p>${sabado[i].programation.group.formationProgram.name}</p>
            <p>Ficha: ${sabado[i].programation.group.codeTab}</p>
            <p>${sabado[i].ambient.name}</p>
            <p>
        ...
        <tr style='height: ${calcHalfHours(sabado[i].endDate, endDate) * 18}px'>
          <td class='ready'>
            <p>Libre</p>
            <p>
              ${new Date(sabado[i].endDate).getHours()}:${new Date(sabado[i].endDate).getMinutes()} - ${endDate.getHours()}:${endDate.getMinutes()==0?endDate.getMinutes()+"0":endDate.getMinutes()}
            </p>
          </td>
        </tr>
        `;
