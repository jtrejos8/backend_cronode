    ...
    if(lunes.length>0){
    	for (var i = 0; i < lunes.length; i++) {
            ...
            ws.cell(row, 2).string(
                lunes[i].constantUser.username +
                "\n" + "Ficha: " +
                lunes[i].programation.group.codeTab +"\n"+lunes[i].programation.group.formationProgram.name);
    ...
    if(martes.length>0){
    	for (var i = 0; i < martes.length; i++) {
            ...
            ws.cell(row, 3).string(
                martes[i].constantUser.username +
                "\n" + "Ficha: " +
                martes[i].programation.group.codeTab +"\n"+martes[i].programation.group.formationProgram.name);
                console.log(new Date(martes[i].endDate).getHours());
    ...
    if(miercoles.length>0){
    	for (var i = 0; i < miercoles.length; i++) {
            ...
            ws.cell(row, 4).string(
                miercoles[i].constantUser.username +
                "\n" + "Ficha: " +
                miercoles[i].programation.group.codeTab +"\n"+miercoles[i].programation.group.formationProgram.name);
    ...
    if(jueves.length>0){
    	for (var i = 0; i < jueves.length; i++) {
            ...
            ws.cell(row, 5).string(
                jueves[i].constantUser.username +
                "\n" + "Ficha: " +
                jueves[i].programation.group.codeTab +"\n"+jueves[i].programation.group.formationProgram.name);
    ...
    if(viernes.length>0){
    	for (var i = 0; i < viernes.length; i++) {
            ...
            ws.cell(row, 6).string(
                viernes[i].constantUser.username +
                "\n" + "Ficha: " +
                viernes[i].programation.group.codeTab +"\n"+viernes[i].programation.group.formationProgram.name);
    ...
    if(sabado.length>0){
    	for (var i = 0; i < sabado.length; i++) {
            ...
            ws.cell(row, 7).string(
                sabado[i].constantUser.username +
                "\n" + "Ficha: " +
                sabado[i].programation.group.codeTab +"\n"+sabado[i].programation.group.formationProgram.name);
