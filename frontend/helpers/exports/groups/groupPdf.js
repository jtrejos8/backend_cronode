...
function createStringToPDF(data) {
    var schedules = data.programation[0].schedule;
    let string = `
    <!DOCTYPE html>
    <html lang="en">
    ...
    * {
    ...
    string += "<h5>" + "Ficha: "+data.codeTab + " - " +"ProgramaFormacion: "+data.formationProgram.name +"</h5>";
    string += "</div>";
    ...
    if (lunes.length > 0) {
        ...
        <td>
            ...
            <p>Ficha: ${lunes[i].constantUser.username}</p>
            <p>
    ...
    if (martes.length > 0) {
        ...
        <td>
            ...
            <p>Ficha: ${martes[i].constantUser.username}</p>
            <p>
    ...
    if (miercoles.length > 0) {
        ...
        <td>
            ...
            <p>Ficha: ${miercoles[i].constantUser.username}</p>
            <p>
    ...
    if (jueves.length > 0) {
        ...
        <td>
            ...
            <p>Ficha: ${jueves[i].constantUser.username}</p>
            <p>
    ...
    if (viernes.length > 0) {
        ...
        <td>
            ...
            <p>Ficha: ${viernes[i].constantUser.username}</p>
            <p>
    ...
    if (sabado.length > 0) {
        ...
        <td>
            ...
            <p>Ficha: ${sabado[i].constantUser.username}</p>
            <p>
